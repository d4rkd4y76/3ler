...
(function () {
  ...
  function injectEarlyScaleCss() {
    ...
    st.textContent =
      ...
      'html.nova-perf-ultra-early.nova-has-session body:not(.birles-pool-fs):not(.birles-kristal-fs):not(.birles-sirala-fs):not(.nova-duel-game-open):not(.roborox-reader-open){zoom:' +
      ULTRA_SCALE +
